...
<div id="header">
	<div class="logo">
<div style="float: left; width: 160px;"><a href="__APP__" target="_blank" title="<?php echo L('website_manage');?>" style="FONT-FAMILY: 楷体">推券客联盟</a> </div>		
	<div class="topnav">
    ...
    <div class="fr">
    	...
    	<div class="cut_line admin_info tr">
			...
			&nbsp;&nbsp;&nbsp;<a href="<?php echo C('yh_site_url');?>" target="_blank">[ <?php echo L('site_home');?> ]</a>
