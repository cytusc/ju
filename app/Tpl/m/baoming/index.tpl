...
<div class="am-g" style="padding-top: 20px;">
  <div class="am-u-md-8 am-u-sm-centered">
   <form action="/?m=baoming&a=enroll" method="post" class="am-form" id="enroll-form">
      <fieldset class="am-form-set">
        <input name="goods_url" required="required" type="text" id="goods_url" class="baominginput" placeholder="报名活动商品的淘宝地址">
        <input name="goods_price" required="required"  type="text" id="goods_price"  class="baominginput" placeholder="参加活动的最低价格">
        <input type="text" id="goods_quan" name="goods_quan" required="required" class="baominginput" placeholder="参加活动的专享优惠券金额">
           <input name="person_name" required="required" id="person_name"  type="text"  class="baominginput" placeholder="您的称呼">
              <input type="text" type="text" id="person_qq" name="person_qq" required="required" class="baominginput" placeholder="联系QQ">
              
              <textarea  id="reason" name="reason"  placeholder="您还可以在这里从客观的角度评价您的商品优势，将有助于报名审核通过。" cols="30" rows="6"> </textarea>
