        ...
        <div>
                ...
                <li class="am-padding-0">
                    <div class="am-gallery-item">
                        <a href="{$item.pict_url}">
                            <img src="{$item.pict_url}_400x400">  </a>
                    </div>
                </li>
            </ul>
            ...
            <div class="fq-grandeur-price fq-background-white am-padding-vertical-sm am-padding-horizontal-xs">
                <ul class="am-avg-sm-3 am-text-sm">
                    <li><if condition="$item.user_type eq '0' "><img height="12" src="__STATIC__/tuiquanke/images/taobao.png"></if><if condition="$item.user_type eq '1' "><img height="12" src="__STATIC__/tuiquanke/images/tmall.png"></if> 在售:{$item.zk_final_price}元</li>
...
<volist name="items_list" id="val" key="i" offset="6" length='6' mod="2">
   ...
   <a href="<if condition="C('URL_MODEL') eq 2 and C('APP_SUB_DOMAIN_DEPLOY') eq true">{:U('/jump/out/',array('id'=>$item['num_iid'],'pid'=>$item['pid'],'quanid'=>$item['quanid']))}<else/>{:U('/m/jump/out/',array('id'=>$item['num_iid'],'quanid'=>$item['quanid'],'pid'=>$item['pid']))}</if>"> 浏览器购买
                                    </a>                            </button>
                        </li>
                        <li>
