				...
				<volist name="items_list" id="item" key="i" mod="4">
					<li class="<eq name="mod" value="3"> last</eq>">
						<div class="deal dealbig">
							<h3 class="stnmclass"><a href="{:U('/item/',array('id'=>$item['id']))}" target="_blank"><img class="lazyload" data-original="{$item.pic_url}_300x300.jpg" /></a><span></span><em class="shem"><a href="{:U('/item/',array('id'=>$item['id']))}" target="_blank">{$item.title}</a></em></h3>
							<div class="beauty_pro_info">
								...
								<a class="buy-btn" href="{:U('/item/',array('id'=>$item['id']))}" target="_blank">去购买</a>
								</p>
							</div>
						</div>
					</li>
