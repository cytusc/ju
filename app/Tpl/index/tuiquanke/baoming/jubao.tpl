...
<style>
.bm-form { border-bottom: dashed 1px #ddd; background-color:#fff; padding:10px 0 0 10px; height: 200px; overflow: hidden; }
...
.bm-form .form-btn .btn { width: 145px; height: 50px; line-height: 50px; text-align: center; display: block; color: #fff; font-size: 18px; background: url(/static/tuiquanke/images/tag_state.gif) no-repeat 0 -160px; text-shadow:1px 1px #ff4700; border:none; cursor:pointer }
...
<body>
	...
	<yh:load type="js" href="__STATIC__/tuiquanke/js/jquery.js,__STATIC__/tuiquanke/js/slider.js,__STATIC__/tuiquanke/js/layer/layer.js,__STATIC__/tuiquanke/js/clipboard.min.js" />
	<script language="JavaScript" src="__STATIC__/tuiquanke/js/base.js"></script>
	<script>
