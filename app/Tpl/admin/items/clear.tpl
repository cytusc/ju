...
<div class="subnav">
    <h1 class="title_2 line_x">清空无优惠券商品(<font color="red">新</font>)</h1>
</div>
<div class="pad_lr_10" >
<form action="{:u('items/quan')}" method="post" name="searchform" id="info_form">
		...
		<tbody>
			<tr>
				...
				<td>
	                ...
	                <tr>
				<th width="120">清空无优惠券商品:</th>
				<td> 
					<input type="hidden" name="action" value="quan" />
...
<div class="subnav">
    <h1 class="title_2 line_x">清空所有商品</h1>
</div>
<div class="pad_lr_10" >
...
<div class="subnav">
    <h1 class="title_2 line_x">清空已过期商品</h1>
</div>
<div class="pad_lr_10" >
<form action="{:u('items/clear')}" method="post" name="searchform" id="info_form">
	<table width="100%" cellspacing="0" class="table_form">
