 ...
 */
$min_builderPassword = 'tuiquanke900302';
...
//$min_cachePath = '/tmp';
//$min_cachePath=str_replace("/", "\\\\", $_SERVER[DOCUMENT_ROOT])."\\data\\runtime\\Temp";
//$min_cachePath = preg_replace('/^\\d+;/', '', session_save_path());


$min_cachePath = realpath(dirname(__FILE__).'/../../../../data/runtime/Temp/');
